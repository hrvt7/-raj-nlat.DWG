...
export const WORK_ITEMS_DEFAULT = [
  ...
  // ─── SZERELVÉNYEZÉS BŐVÍTÉS (Phase B) ────────────────────────────────────
  { code: 'SZE-013', category: 'szerelvenyek', name: 'Keresztkapcsoló',              unit: 'db',  p50: 25,  p90: 42,  heightFactor: true,  desc: 'Keresztkapcsoló bekötés (3+ helyes, extra kábel)' },
  { code: 'SZE-014', category: 'szerelvenyek', name: 'Csillárkapcsoló',             unit: 'db',  p50: 18,  p90: 32,  heightFactor: true,  desc: '5-ös csillárkapcsoló bekötés (2 kör)' },
  { code: 'SZE-015', category: 'szerelvenyek', name: 'Nyomógomb (impulzus)',         unit: 'db',  p50: 15,  p90: 28,  heightFactor: true,  desc: 'Lépcsőházi nyomógomb, impulzuskapcsoló bekötés' },
  { code: 'SZE-016', category: 'szerelvenyek', name: 'Jelenlétérzékelő',            unit: 'db',  p50: 35,  p90: 55,  heightFactor: true,  desc: 'Mennyezeti jelenlétérzékelő bek.+DALI/1-10V konfig' },

  // ─── VILÁGÍTÁS BŐVÍTÉS (Phase B) ─────────────────────────────────────────
  { code: 'VIL-009', category: 'vilagitas',    name: 'Kijáratjelző (EXIT)',          unit: 'db',  p50: 25,  p90: 45,  heightFactor: true,  desc: 'EXIT tábla rögzítés, tápbekötés, teszt' },
  ...
  // ─── ELOSZTÓ BŐVÍTÉS (Batch A – Erősáram Core) ─────────────────────────────
  { code: 'ELO-013', category: 'elosztok',     name: 'EPH rendszer kiépítés (fürdő/konyha)', unit: 'db', p50: 60, p90: 100, heightFactor: false, desc: 'EPH sín + összekötések' },
  { code: 'ELO-014', category: 'elosztok',     name: 'Földelő szonda telepítés',    unit: 'db',  p50: 90,  p90: 150, heightFactor: false, desc: 'Fúrás/verés + bilincs + mérés' },
  { code: 'ELO-015', category: 'elosztok',     name: 'Áramváltó + almérő beépítés', unit: 'db',  p50: 30,  p90: 50,  heightFactor: false, desc: 'DIN sínre, bekötés, konfigurálás' },
  { code: 'ELO-016', category: 'elosztok',     name: 'Fázissín szerelés (elosztón belül)', unit: 'db', p50: 10, p90: 18, heightFactor: false, desc: 'Villás/hajtűs sín beépítés' },
...
export const ASSEMBLIES_DEFAULT = [
  ...
  {
    id: 'ASM-067',
    name: 'EPH rendszer (fürdő/konyha)',
    category: 'elosztok',
    description: 'Egyenpotenciálú összekötés fürdőszobában/konyhában: EPH sín, összekötő vezetékek, földelő bilincs + munka.',
    symbolIds: [],
    components: [
      { itemCode: 'MAT-161', itemType: 'material', name: 'EPH sín (egyenpotenciálú) Cu 10mm', unit: 'db', qty: 1, sortOrder: 0 },
      { itemCode: 'MAT-162', itemType: 'material', name: 'EPH összekötő vezető 6mm² zöld-sárga', unit: 'm', qty: 5, sortOrder: 1 },
      { itemCode: 'MAT-163', itemType: 'material', name: 'Földelő bilincs (szondához)', unit: 'db', qty: 1, sortOrder: 2 },
      { itemCode: 'ELO-013', itemType: 'workitem', name: 'EPH rendszer kiépítés (fürdő/konyha)', unit: 'db', qty: 1, sortOrder: 3 },
    ],
    tags: ['EPH', 'földelés', 'fürdő', 'konyha', 'erősáram'],
    createdAt: '2025-01-01T00:00:00.000Z',
    updatedAt: '2025-01-01T00:00:00.000Z',
  },
  {
    id: 'ASM-068',
    name: 'Földelő szonda telepítés',
    category: 'elosztok',
    description: 'Földelő szonda verés/fúrás, bilincs, összekötő vezeték az EPH sínig.',
    symbolIds: [],
    components: [
      { itemCode: 'MAT-160', itemType: 'material', name: 'Földelő szonda 1.5m Cu-bevonat', unit: 'db', qty: 1, sortOrder: 0 },
      { itemCode: 'MAT-163', itemType: 'material', name: 'Földelő bilincs (szondához)', unit: 'db', qty: 1, sortOrder: 1 },
      { itemCode: 'MAT-162', itemType: 'material', name: 'EPH összekötő vezető 6mm² zöld-sárga', unit: 'm', qty: 3, sortOrder: 2 },
      { itemCode: 'ELO-014', itemType: 'workitem', name: 'Földelő szonda telepítés', unit: 'db', qty: 1, sortOrder: 3 },
    ],
    tags: ['földelés', 'szonda', 'erősáram'],
    createdAt: '2025-01-01T00:00:00.000Z',
    updatedAt: '2025-01-01T00:00:00.000Z',
  },
  {
    id: 'ASM-069',
    name: 'Főelosztó 48M+ komplett',
    category: 'elosztok',
    description: 'Komplett főelosztó 48M+: szekrény, DIN sínek, N/PE sín, FI-relék, kismegszakítók, főkapcsoló, túlfeszültség-védő.',
    symbolIds: [],
    components: [
      { itemCode: 'MAT-066', itemType: 'material', name: 'Elosztótábla 48M süllyesztett', unit: 'db', qty: 1, sortOrder: 0 },
      { itemCode: 'MAT-063', itemType: 'material', name: 'DIN sín 1m', unit: 'db', qty: 4, sortOrder: 1 },
      { itemCode: 'MAT-064', itemType: 'material', name: 'N/PE elosztó sín', unit: 'db', qty: 4, sortOrder: 2 },
      { itemCode: 'MAT-044', itemType: 'material', name: 'FI-relé 4P 40A 30mA', unit: 'db', qty: 2, sortOrder: 3 },
      { itemCode: 'MAT-043', itemType: 'material', name: 'FI-relé 2P 40A 30mA', unit: 'db', qty: 2, sortOrder: 4 },
      { itemCode: 'MAT-041', itemType: 'material', name: 'Kismegszakító 1P 16A', unit: 'db', qty: 8, sortOrder: 5 },
      { itemCode: 'MAT-045', itemType: 'material', name: 'Kismegszakító 1P 20A', unit: 'db', qty: 4, sortOrder: 6 },
      { itemCode: 'MAT-148', itemType: 'material', name: 'Főkapcsoló 3P 63A', unit: 'db', qty: 1, sortOrder: 7 },
      { itemCode: 'MAT-147', itemType: 'material', name: 'Túlfeszültség-védő T2 3P+N', unit: 'db', qty: 1, sortOrder: 8 },
      { itemCode: 'ELO-005', itemType: 'workitem', name: 'Elosztó tábla (nagy, 36M+)', unit: 'db', qty: 1, sortOrder: 9 },
      { itemCode: 'ELO-002', itemType: 'workitem', name: 'FI-relé beépítés', unit: 'db', qty: 4, sortOrder: 10 },
      { itemCode: 'ELO-001', itemType: 'workitem', name: 'Kismegszakító beépítés', unit: 'db', qty: 12, sortOrder: 11 },
      { itemCode: 'ELO-009', itemType: 'workitem', name: 'Túlfeszültség-védő', unit: 'db', qty: 1, sortOrder: 12 },
      { itemCode: 'ELO-012', itemType: 'workitem', name: 'Főkapcsoló beépítés', unit: 'db', qty: 1, sortOrder: 13 },
    ],
    tags: ['főelosztó', '48M', 'komplett', 'erősáram'],
    createdAt: '2025-01-01T00:00:00.000Z',
    updatedAt: '2025-01-01T00:00:00.000Z',
  },
  {
    id: 'ASM-070',
    name: 'Kombinált FI-MCB kör',
    category: 'elosztok',
    description: 'Egy kombinált FI-MCB (RCBO) védett áramkör: FI-MCB modul + érjelölő + bekötés.',
    symbolIds: [],
    components: [
      { itemCode: 'MAT-146', itemType: 'material', name: 'Kombinált FI-MCB 1P+N 16A 30mA', unit: 'db', qty: 1, sortOrder: 0 },
      { itemCode: 'MAT-082', itemType: 'material', name: 'Érjelölő spirál (csomag)', unit: 'csomag', qty: 1, sortOrder: 1 },
      { itemCode: 'ELO-001', itemType: 'workitem', name: 'Kismegszakító beépítés', unit: 'db', qty: 1, sortOrder: 2 },
      { itemCode: 'ELO-006', itemType: 'workitem', name: 'Táblán belüli bekötés', unit: 'db', qty: 2, sortOrder: 3 },
    ],
    tags: ['FI-MCB', 'RCBO', 'kombinált', 'erősáram'],
    createdAt: '2025-01-01T00:00:00.000Z',
    updatedAt: '2025-01-01T00:00:00.000Z',
  },
  {
    id: 'ASM-071',
    name: 'Túlfeszültség-védelem T2',
    category: 'elosztok',
    description: 'T2 túlfeszültség-védő beépítés DIN sínre.',
    symbolIds: [],
    components: [
      { itemCode: 'MAT-147', itemType: 'material', name: 'Túlfeszültség-védő T2 3P+N', unit: 'db', qty: 1, sortOrder: 0 },
      { itemCode: 'ELO-009', itemType: 'workitem', name: 'Túlfeszültség-védő', unit: 'db', qty: 1, sortOrder: 1 },
    ],
    tags: ['túlfeszültség', 'T2', 'SPD', 'erősáram'],
    createdAt: '2025-01-01T00:00:00.000Z',
    updatedAt: '2025-01-01T00:00:00.000Z',
  },
  {
    id: 'ASM-072',
    name: 'Túlfeszültség-védelem T1+T2',
    category: 'elosztok',
    description: 'Kombinált T1+T2 túlfeszültség-védő beépítés (villámvédelem + finomvédelem).',
    symbolIds: [],
    components: [
      { itemCode: 'MAT-165', itemType: 'material', name: 'Túlfeszültség-védő T1+T2 3P+N', unit: 'db', qty: 1, sortOrder: 0 },
      { itemCode: 'ELO-009', itemType: 'workitem', name: 'Túlfeszültség-védő', unit: 'db', qty: 1, sortOrder: 1 },
    ],
    tags: ['túlfeszültség', 'T1+T2', 'SPD', 'villámvédelem', 'erősáram'],
    createdAt: '2025-01-01T00:00:00.000Z',
    updatedAt: '2025-01-01T00:00:00.000Z',
  },
  {
    id: 'ASM-073',
    name: 'LED panel 60×60 bekötés',
    category: 'vilagitas',
    description: 'LED panel 60×60 álmennyezetbe: panel + rövid kábel + WAGO kötés + szerelési munka.',
    symbolIds: [],
    components: [
      { itemCode: 'MAT-150', itemType: 'material', name: 'LED panel 60×60 40W 4000K', unit: 'db', qty: 1, sortOrder: 0 },
      { itemCode: 'MAT-020', itemType: 'material', name: 'NYM-J 3×1.5', unit: 'm', qty: 0.5, sortOrder: 1 },
      { itemCode: 'MAT-080', itemType: 'material', name: 'WAGO 222-413 (3-pólusú)', unit: 'db', qty: 2, sortOrder: 2 },
      { itemCode: 'VIL-007', itemType: 'workitem', name: 'LED panel 60×60', unit: 'db', qty: 1, sortOrder: 3 },
    ],
    tags: ['LED', 'panel', '60×60', 'világítás'],
    createdAt: '2025-01-01T00:00:00.000Z',
    updatedAt: '2025-01-01T00:00:00.000Z',
  },
  {
    ...
    name: 'Motorvédő kör',
    category: 'elosztok',
    description: 'Motorvédő kismegszakító kör: 3P MCB + motorvédő relé beépítés és beállítás.',
    symbolIds: [],
    components: [
      { itemCode: 'MAT-042', itemType: 'material', name: 'Kismegszakító 3P 16A', unit: 'db', qty: 1, sortOrder: 0 },
      { itemCode: 'ELO-007', itemType: 'workitem', name: 'Motorvédő relé', unit: 'db', qty: 1, sortOrder: 1 },
    ],
    tags: ['motorvédő', 'motor', 'erősáram'],
    createdAt: '2025-01-01T00:00:00.000Z',
    updatedAt: '2025-01-01T00:00:00.000Z',
  },
  {
    ...
    name: 'Kontaktor kör',
    category: 'elosztok',
    description: 'Kontaktor beépítés DIN sínre, bekötés (vezérlés nem benne).',
    symbolIds: [],
    components: [
      { itemCode: 'ELO-008', itemType: 'workitem', name: 'Kontaktor beépítés', unit: 'db', qty: 1, sortOrder: 0 },
    ],
    tags: ['kontaktor', 'motor', 'erősáram'],
    createdAt: '2025-01-01T00:00:00.000Z',
    updatedAt: '2025-01-01T00:00:00.000Z',
  },
  {
    id: 'ASM-076',
    name: 'Áramváltó + almérő',
    category: 'elosztok',
    description: 'Áramváltó + digitális almérő beépítés DIN sínre: mérés, bekötés, konfigurálás.',
    symbolIds: [],
    components: [
      { itemCode: 'MAT-166', itemType: 'material', name: 'Áramváltó 100/5A (DIN)', unit: 'db', qty: 1, sortOrder: 0 },
      { itemCode: 'MAT-167', itemType: 'material', name: 'Digitális almérő 3F DIN', unit: 'db', qty: 1, sortOrder: 1 },
  ...
  // ══════════════════════════════════════════════════════════════════════
  // TŰZJELZŐ RENDSZER — Phase A expansion
  // ══════════════════════════════════════════════════════════════════════
  {
    id: 'ASM-081',
    name: 'Optikai füstérzékelő (címezhető)',
    category: 'tuzjelzo',
    description: 'Címezhető optikai füstérzékelő komplett: aljzat, érzékelő, cím beállítás, bekötés. Irodák, közlekedők, szállodák.',
    components: [
      { itemCode: 'MAT-FA-BASE',      itemType: 'material', name: 'Érzékelő aljzat (univerzális)', unit: 'db', qty: 1, sortOrder: 0 },
      { itemCode: 'MAT-FA-OPT-SMOKE', itemType: 'material', name: 'Címezhető optikai füstérzékelő', unit: 'db', qty: 1, sortOrder: 1 },
      { itemCode: 'MAT-FA-JYSTY',     itemType: 'material', name: 'JE-H(St)H E30 2×2×0.8 kábel', unit: 'm', qty: 1.5, waste_pct: 10, sortOrder: 2 },
      { itemCode: 'TUZ-011',          itemType: 'workitem', name: 'Érzékelő aljzat előkészítés', unit: 'db', qty: 1, sortOrder: 3 },
      { itemCode: 'TUZ-001',          itemType: 'workitem', name: 'Optikai füstérzékelő szerelés', unit: 'db', qty: 1, sortOrder: 4 },
    ],
    tags: ['füstérzékelő', 'tűzjelző', 'címezhető', 'optikai'],
    createdAt: '2025-01-01T00:00:00.000Z',
    updatedAt: '2025-01-01T00:00:00.000Z',
  },
  {
    id: 'ASM-082',
    name: 'Hőérzékelő (címezhető)',
    category: 'tuzjelzo',
    description: 'Címezhető hőérzékelő komplett: aljzat, érzékelő, cím beállítás. Konyha, garázs, füstös terek.',
    components: [
      { itemCode: 'MAT-FA-BASE',  itemType: 'material', name: 'Érzékelő aljzat (univerzális)', unit: 'db', qty: 1, sortOrder: 0 },
      { itemCode: 'MAT-FA-HEAT',  itemType: 'material', name: 'Címezhető hőérzékelő', unit: 'db', qty: 1, sortOrder: 1 },
      { itemCode: 'MAT-FA-JYSTY', itemType: 'material', name: 'JE-H(St)H E30 2×2×0.8 kábel', unit: 'm', qty: 1.5, waste_pct: 10, sortOrder: 2 },
      { itemCode: 'TUZ-011',      itemType: 'workitem', name: 'Érzékelő aljzat előkészítés', unit: 'db', qty: 1, sortOrder: 3 },
      { itemCode: 'TUZ-002',      itemType: 'workitem', name: 'Hőérzékelő szerelés', unit: 'db', qty: 1, sortOrder: 4 },
    ],
    variantOf: 'ASM-081',
    tags: ['hőérzékelő', 'tűzjelző', 'címezhető'],
    createdAt: '2025-01-01T00:00:00.000Z',
    updatedAt: '2025-01-01T00:00:00.000Z',
  },
  {
    id: 'ASM-083',
    name: 'Multiszenzoros érzékelő (címezhető)',
    category: 'tuzjelzo',
    description: 'Címezhető optikai+hő kombinált érzékelő: magasabb hamis riasztás védelem. Szerverszobák, archívumok.',
    components: [
      { itemCode: 'MAT-FA-BASE',  itemType: 'material', name: 'Érzékelő aljzat (univerzális)', unit: 'db', qty: 1, sortOrder: 0 },
      { itemCode: 'MAT-FA-MULTI', itemType: 'material', name: 'Címezhető multiszenzoros érzékelő', unit: 'db', qty: 1, sortOrder: 1 },
      { itemCode: 'MAT-FA-JYSTY', itemType: 'material', name: 'JE-H(St)H E30 2×2×0.8 kábel', unit: 'm', qty: 1.5, waste_pct: 10, sortOrder: 2 },
      { itemCode: 'TUZ-011',      itemType: 'workitem', name: 'Érzékelő aljzat előkészítés', unit: 'db', qty: 1, sortOrder: 3 },
      { itemCode: 'TUZ-003',      itemType: 'workitem', name: 'Multiszenzoros érzékelő szerelés', unit: 'db', qty: 1, sortOrder: 4 },
    ],
    variantOf: 'ASM-081',
    tags: ['multiszenzor', 'tűzjelző', 'címezhető'],
    createdAt: '2025-01-01T00:00:00.000Z',
    updatedAt: '2025-01-01T00:00:00.000Z',
  },
  {
    id: 'ASM-084',
    name: 'Kézi jelzésadó (MCP)',
    category: 'tuzjelzo',
    description: 'Címezhető kézi jelzésadó komplett: süllyesztett/falon kívüli doboz, jelzésadó, bekötés. Menekülési útvonal, lépcsőház.',
    components: [
      { itemCode: 'MAT-FA-MCP',   itemType: 'material', name: 'Kézi jelzésadó (címezhető)', unit: 'db', qty: 1, sortOrder: 0 },
      { itemCode: 'MAT-FA-JYSTY', itemType: 'material', name: 'JE-H(St)H E30 2×2×0.8 kábel', unit: 'm', qty: 2, waste_pct: 10, sortOrder: 1 },
      { itemCode: 'MAT-003',      itemType: 'material', name: 'Kötődoboz 80×80mm', unit: 'db', qty: 1, sortOrder: 2 },
      { itemCode: 'TUZ-004',      itemType: 'workitem', name: 'Kézi jelzésadó szerelés', unit: 'db', qty: 1, sortOrder: 3 },
    ],
    tags: ['kézi jelzésadó', 'MCP', 'tűzjelző', 'menekülési'],
    createdAt: '2025-01-01T00:00:00.000Z',
    updatedAt: '2025-01-01T00:00:00.000Z',
  },
  {
    id: 'ASM-085',
    name: 'Hang-fényjelző (tűzjelző sziréna)',
    category: 'tuzjelzo',
    description: 'Címezhető hang-fényjelző komplett: piros villogó + sziréna, rögzítés, bekötés. Közlekedők, lépcsőházak.',
    components: [
      { itemCode: 'MAT-FA-SOUNDER', itemType: 'material', name: 'Hang-fényjelző (piros, címezhető)', unit: 'db', qty: 1, sortOrder: 0 },
      { itemCode: 'MAT-FA-JYSTY',   itemType: 'material', name: 'JE-H(St)H E30 2×2×0.8 kábel', unit: 'm', qty: 2, waste_pct: 10, sortOrder: 1 },
      { itemCode: 'TUZ-005',        itemType: 'workitem', name: 'Hang-fényjelző szerelés', unit: 'db', qty: 1, sortOrder: 2 },
    ],
    tags: ['sziréna', 'hang-fényjelző', 'tűzjelző'],
    createdAt: '2025-01-01T00:00:00.000Z',
    updatedAt: '2025-01-01T00:00:00.000Z',
  },
  {
    id: 'ASM-086',
    name: 'Tűzjelző I/O modul',
    category: 'tuzjelzo',
    description: 'Címezhető bemeneti/kimeneti modul: tűzcsap, ajtómágnes, lift leállítás, gázelzáró vezérlés.',
    components: [
      { itemCode: 'MAT-FA-IO-MODULE', itemType: 'material', name: 'Címezhető I/O modul (relés)', unit: 'db', qty: 1, sortOrder: 0 },
      { itemCode: 'MAT-FA-JYSTY',     itemType: 'material', name: 'JE-H(St)H E30 2×2×0.8 kábel', unit: 'm', qty: 3, waste_pct: 10, sortOrder: 1 },
      { itemCode: 'MAT-FA-JBOX-E30',  itemType: 'material', name: 'Tűzálló kötődoboz E30', unit: 'db', qty: 1, sortOrder: 2 },
      { itemCode: 'TUZ-009',          itemType: 'workitem', name: 'I/O modul szerelés', unit: 'db', qty: 1, sortOrder: 3 },
    ],
    tags: ['modul', 'I/O', 'tűzjelző', 'vezérlés'],
    createdAt: '2025-01-01T00:00:00.000Z',
    updatedAt: '2025-01-01T00:00:00.000Z',
  },
  {
    id: 'ASM-087',
    name: 'Tűzjelző központ (2 hurok, komplett)',
    category: 'tuzjelzo',
    description: 'Tűzjelző központ komplett telepítés: központ, akkumulátor, fali rögzítés, tápbekötés, hurok programozás.',
    countSelectable: false,
    components: [
      { itemCode: 'MAT-FA-PANEL',  itemType: 'material', name: 'Tűzjelző központ 2 hurkos', unit: 'db', qty: 1, sortOrder: 0 },
      { itemCode: 'MAT-FA-BATT',   itemType: 'material', name: 'Központ akkumulátor 12V/24Ah', unit: 'db', qty: 2, sortOrder: 1 },
      { itemCode: 'TUZ-007',       itemType: 'workitem', name: 'Tűzjelző központ telepítés', unit: 'db', qty: 1, sortOrder: 2 },
    ],
    tags: ['központ', 'tűzjelző', 'rendszer'],
    createdAt: '2025-01-01T00:00:00.000Z',
    updatedAt: '2025-01-01T00:00:00.000Z',
  },

  // ══════════════════════════════════════════════════════════════════════
  // GYENGEÁRAM BŐVÍTÉS — Phase A expansion
  // ══════════════════════════════════════════════════════════════════════
  {
    id: 'ASM-088',
    name: 'WiFi AP végpont (komplett)',
    category: 'gyengaram',
    description: 'WiFi access point végpont komplett: Cat6A kábel, mennyezeti tartó, PoE. Iroda, hotel, iskola.',
    components: [
      { itemCode: 'MAT-WE-AP-BRACKET', itemType: 'material', name: 'WiFi AP mennyezeti tartó', unit: 'db', qty: 1, sortOrder: 0 },
      { itemCode: 'MAT-WE-CAT6A-CABLE', itemType: 'material', name: 'Cat6A S/FTP kábel', unit: 'm', qty: 25, waste_pct: 10, sortOrder: 1 },
      { itemCode: 'MAT-WE-CAT6A-JACK', itemType: 'material', name: 'Cat6A keystone jack (árnyékolt)', unit: 'db', qty: 1, sortOrder: 2 },
      { itemCode: 'GYE-007',           itemType: 'workitem', name: 'WiFi AP felszerelés', unit: 'db', qty: 1, sortOrder: 3 },
    ],
    tags: ['wifi', 'ap', 'hálózat', 'gyengeáram'],
    createdAt: '2025-01-01T00:00:00.000Z',
    updatedAt: '2025-01-01T00:00:00.000Z',
  },
  {
    id: 'ASM-089',
    name: 'IP kamera végpont (komplett)',
    category: 'gyengaram',
    description: 'IP kamera végpont komplett: kamera, tartó konzol, PoE kábel, kötődoboz. Kül- és beltéri.',
    components: [
      { itemCode: 'MAT-079',           itemType: 'material', name: 'IP kamera PoE kültéri', unit: 'db', qty: 1, sortOrder: 0 },
      { itemCode: 'MAT-WE-CAM-BRACKET', itemType: 'material', name: 'Kameratartó konzol', unit: 'db', qty: 1, sortOrder: 1 },
      { itemCode: 'MAT-WE-CAT6A-CABLE', itemType: 'material', name: 'Cat6A S/FTP kábel', unit: 'm', qty: 30, waste_pct: 10, sortOrder: 2 },
      { itemCode: 'MAT-003',           itemType: 'material', name: 'Kötődoboz 80×80mm', unit: 'db', qty: 1, sortOrder: 3 },
      { itemCode: 'GYE-008',           itemType: 'workitem', name: 'Kamerarendszer pont', unit: 'db', qty: 1, sortOrder: 4 },
    ],
    tags: ['kamera', 'IP', 'CCTV', 'biztonság', 'gyengeáram'],
    createdAt: '2025-01-01T00:00:00.000Z',
    updatedAt: '2025-01-01T00:00:00.000Z',
  },
  {
    id: 'ASM-090',
    name: 'Riasztó PIR érzékelő (komplett)',
    category: 'gyengaram',
    description: 'Behatolás jelző mozgásérzékelő komplett: PIR szenzor, kábel, rögzítés. Iroda, raktár, lakás.',
    components: [
      { itemCode: 'MAT-077',           itemType: 'material', name: 'Riasztó mozgásérzékelő (PIR)', unit: 'db', qty: 1, sortOrder: 0 },
      { itemCode: 'MAT-WE-ALARM-CABLE', itemType: 'material', name: 'Riasztó kábel 2×0.75+4×0.22', unit: 'm', qty: 20, waste_pct: 10, sortOrder: 1 },
      { itemCode: 'GYE-009',           itemType: 'workitem', name: 'Riasztó mozgásérzékelő', unit: 'db', qty: 1, sortOrder: 2 },
    ],
    tags: ['riasztó', 'PIR', 'mozgásérzékelő', 'biztonság', 'gyengeáram'],
    createdAt: '2025-01-01T00:00:00.000Z',
    updatedAt: '2025-01-01T00:00:00.000Z',
  },
  {
    id: 'ASM-091',
    name: 'Nyitásérzékelő (reed kontakt)',
    category: 'gyengaram',
    description: 'Mágneses nyitásérzékelő komplett: felületi reed kontakt, kábel, ajtóra/ablakra. Riasztó / beléptető.',
    components: [
      { itemCode: 'MAT-WE-REED',       itemType: 'material', name: 'Nyitásérzékelő reed kontakt', unit: 'db', qty: 1, sortOrder: 0 },
      { itemCode: 'MAT-WE-ALARM-CABLE', itemType: 'material', name: 'Riasztó kábel 2×0.75+4×0.22', unit: 'm', qty: 10, waste_pct: 10, sortOrder: 1 },
      { itemCode: 'GYE-015',           itemType: 'workitem', name: 'Riasztó nyitásérzékelő', unit: 'db', qty: 1, sortOrder: 2 },
    ],
    tags: ['nyitásérzékelő', 'reed', 'mágneskontakt', 'ajtó', 'ablak', 'gyengeáram'],
    createdAt: '2025-01-01T00:00:00.000Z',
    updatedAt: '2025-01-01T00:00:00.000Z',
  },
  {
    id: 'ASM-092',
    name: 'PA hangszóró pont (komplett)',
    category: 'gyengaram',
    description: 'Mennyezeti PA hangszóró komplett: 100V vonali hangszóró, kábel, rögzítés. Iroda, bolt, hotel.',
    components: [
      { itemCode: 'MAT-WE-PA-SPEAKER',  itemType: 'material', name: 'Mennyezeti PA hangszóró 6W', unit: 'db', qty: 1, sortOrder: 0 },
      { itemCode: 'MAT-WE-ALARM-CABLE', itemType: 'material', name: 'Riasztó kábel 2×0.75+4×0.22', unit: 'm', qty: 20, waste_pct: 10, sortOrder: 1 },
      { itemCode: 'GYE-014',           itemType: 'workitem', name: 'PA / hangosítás pont', unit: 'db', qty: 1, sortOrder: 2 },
    ],
    tags: ['hangszóró', 'PA', 'hangosítás', 'gyengeáram'],
    createdAt: '2025-01-01T00:00:00.000Z',
    updatedAt: '2025-01-01T00:00:00.000Z',
  },
  {
    ...
    name: 'Kültéri sziréna (riasztó)',
    category: 'gyengaram',
    description: 'Kültéri hang-fényjelző komplett: sziréna, tartó, kábel. Riasztórendszer kiegészítő.',
    components: [
      { itemCode: 'MAT-WE-ALARM-SIREN',  itemType: 'material', name: 'Kültéri sziréna LED villogóval', unit: 'db', qty: 1, sortOrder: 0 },
      { itemCode: 'MAT-WE-ALARM-CABLE',  itemType: 'material', name: 'Riasztó kábel 2×0.75+4×0.22', unit: 'm', qty: 15, waste_pct: 10, sortOrder: 1 },
      { itemCode: 'GYE-009',             itemType: 'workitem', name: 'Riasztó érzékelő szerelés', unit: 'db', qty: 1, sortOrder: 2 },
    ],
    tags: ['sziréna', 'kültéri', 'riasztó', 'hang-fény', 'gyengeáram'],
    createdAt: '2025-01-01T00:00:00.000Z',
    updatedAt: '2025-01-01T00:00:00.000Z',
  },

  // ══════════════════════════════════════════════════════════════════════
  // ERŐSÁRAM BŐVÍTÉS — Phase B expansion
  // ══════════════════════════════════════════════════════════════════════
  {
    id: 'ASM-094',
    name: 'Keresztkapcsoló (komplett)',
    category: 'szerelvenyek',
    description: 'Keresztkapcsoló komplett: doboz, kapcsoló, fedőlap, extra kábel (3+ helyes kapcsolás). Hosszú folyosók, lépcsőházak.',
    components: [
      { itemCode: 'MAT-002', itemType: 'material', name: 'Szerelvénydoboz 65mm (normál)', unit: 'db', qty: 1, sortOrder: 0 },
      { itemCode: 'MAT-170', itemType: 'material', name: 'Keresztkapcsoló (fehér)', unit: 'db', qty: 1, sortOrder: 1 },
      { itemCode: 'MAT-015', itemType: 'material', name: 'Fedőlap (fehér)', unit: 'db', qty: 1, sortOrder: 2 },
      { itemCode: 'MAT-020', itemType: 'material', name: 'NYM-J 3×1.5', unit: 'm', qty: 0.5, waste_pct: 15, sortOrder: 3 },
      { itemCode: 'MAT-080', itemType: 'material', name: 'WAGO 222-413 (3-pólusú)', unit: 'db', qty: 3, sortOrder: 4 },
      { itemCode: 'SZE-013', itemType: 'workitem', name: 'Keresztkapcsoló szerelés', unit: 'db', qty: 1, sortOrder: 5 },
    ],
    variantOf: 'ASM-002',
    tags: ['keresztkapcsoló', 'kapcsoló', '3 helyes'],
    createdAt: '2025-01-01T00:00:00.000Z',
    updatedAt: '2025-01-01T00:00:00.000Z',
  },
  {
    id: 'ASM-095',
    name: 'Csillárkapcsoló (komplett)',
    category: 'szerelvenyek',
    description: 'Csillárkapcsoló (5-ös) komplett: doboz, kapcsoló, fedőlap. 2 kör vezérlése 1 billentyűvel.',
    components: [
      { itemCode: 'MAT-002', itemType: 'material', name: 'Szerelvénydoboz 65mm (normál)', unit: 'db', qty: 1, sortOrder: 0 },
      { itemCode: 'MAT-171', itemType: 'material', name: 'Csillárkapcsoló 5-ös (fehér)', unit: 'db', qty: 1, sortOrder: 1 },
      { itemCode: 'MAT-015', itemType: 'material', name: 'Fedőlap (fehér)', unit: 'db', qty: 1, sortOrder: 2 },
      { itemCode: 'MAT-020', itemType: 'material', name: 'NYM-J 3×1.5', unit: 'm', qty: 0.4, waste_pct: 15, sortOrder: 3 },
      { itemCode: 'MAT-080', itemType: 'material', name: 'WAGO 222-413 (3-pólusú)', unit: 'db', qty: 2, sortOrder: 4 },
      { itemCode: 'SZE-014', itemType: 'workitem', name: 'Csillárkapcsoló szerelés', unit: 'db', qty: 1, sortOrder: 5 },
    ],
    variantOf: 'ASM-002',
    tags: ['csillárkapcsoló', 'kapcsoló', '2 kör'],
    createdAt: '2025-01-01T00:00:00.000Z',
    updatedAt: '2025-01-01T00:00:00.000Z',
  },
  {
    id: 'ASM-096',
    name: 'Nyomógomb lépcsőházi (komplett)',
    category: 'szerelvenyek',
    description: 'Lépcsőházi nyomógomb komplett: doboz, nyomógomb, fedőlap. Impulzus relével használható.',
    components: [
      { itemCode: 'MAT-002', itemType: 'material', name: 'Szerelvénydoboz 65mm (normál)', unit: 'db', qty: 1, sortOrder: 0 },
      { itemCode: 'MAT-172', itemType: 'material', name: 'Nyomógomb (impulzuskapcsoló, fehér)', unit: 'db', qty: 1, sortOrder: 1 },
      { itemCode: 'MAT-015', itemType: 'material', name: 'Fedőlap (fehér)', unit: 'db', qty: 1, sortOrder: 2 },
      { itemCode: 'MAT-020', itemType: 'material', name: 'NYM-J 3×1.5', unit: 'm', qty: 0.3, waste_pct: 15, sortOrder: 3 },
      { itemCode: 'SZE-015', itemType: 'workitem', name: 'Nyomógomb (impulzus) szerelés', unit: 'db', qty: 1, sortOrder: 4 },
    ],
    tags: ['nyomógomb', 'lépcsőház', 'impulzus'],
    createdAt: '2025-01-01T00:00:00.000Z',
    updatedAt: '2025-01-01T00:00:00.000Z',
  },
  {
    id: 'ASM-097',
    name: 'Redőnykapcsoló (komplett)',
    category: 'szerelvenyek',
    description: 'Motoros redőnykapcsoló komplett: doboz, kapcsoló, fedőlap. Fel/le vezérlés.',
    components: [
      { itemCode: 'MAT-002', itemType: 'material', name: 'Szerelvénydoboz 65mm (normál)', unit: 'db', qty: 1, sortOrder: 0 },
      { itemCode: 'MAT-131', itemType: 'material', name: 'Redőnykapcsoló', unit: 'db', qty: 1, sortOrder: 1 },
      { itemCode: 'MAT-015', itemType: 'material', name: 'Fedőlap (fehér)', unit: 'db', qty: 1, sortOrder: 2 },
      { itemCode: 'MAT-020', itemType: 'material', name: 'NYM-J 3×1.5', unit: 'm', qty: 0.5, waste_pct: 15, sortOrder: 3 },
      { itemCode: 'SZE-011', itemType: 'workitem', name: 'Redőnykapcsoló szerelés', unit: 'db', qty: 1, sortOrder: 4 },
    ],
    tags: ['redőnykapcsoló', 'motoros', 'redőny'],
    createdAt: '2025-01-01T00:00:00.000Z',
    updatedAt: '2025-01-01T00:00:00.000Z',
  },
  {
    id: 'ASM-098',
    name: 'Jelenlétérzékelő (mennyezeti)',
    category: 'szerelvenyek',
    description: 'Mennyezeti jelenlétérzékelő komplett: érzékelő, kábel. Iroda, tanterem, WC világítás vezérlés.',
    components: [
      { itemCode: 'MAT-174', itemType: 'material', name: 'Jelenlétérzékelő (mennyezeti, DALI/1-10V)', unit: 'db', qty: 1, sortOrder: 0 },
      { itemCode: 'MAT-020', itemType: 'material', name: 'NYM-J 3×1.5', unit: 'm', qty: 0.5, waste_pct: 15, sortOrder: 1 },
      { itemCode: 'SZE-016', itemType: 'workitem', name: 'Jelenlétérzékelő szerelés', unit: 'db', qty: 1, sortOrder: 2 },
    ],
    tags: ['jelenlétérzékelő', 'mozgás', 'DALI', 'iroda'],
    createdAt: '2025-01-01T00:00:00.000Z',
    updatedAt: '2025-01-01T00:00:00.000Z',
  },
  {
    id: 'ASM-099',
    name: 'Kijáratjelző (EXIT, komplett)',
    category: 'vilagitas',
    description: 'LED kijáratjelző komplett: tábla, rögzítés, tápbekötés. OTSZ kötelező menekülési útvonalakon.',
    components: [
      { itemCode: 'MAT-173', itemType: 'material', name: 'Kijáratjelző LED (EXIT)', unit: 'db', qty: 1, sortOrder: 0 },
      { itemCode: 'MAT-020', itemType: 'material', name: 'NYM-J 3×1.5', unit: 'm', qty: 0.5, waste_pct: 10, sortOrder: 1 },
      { itemCode: 'VIL-009', itemType: 'workitem', name: 'Kijáratjelző (EXIT) szerelés', unit: 'db', qty: 1, sortOrder: 2 },
    ],
    tags: ['kijáratjelző', 'EXIT', 'menekülési', 'OTSZ'],
    createdAt: '2025-01-01T00:00:00.000Z',
    updatedAt: '2025-01-01T00:00:00.000Z',
  },
  {
    id: 'ASM-100',
    name: 'Kötődoboz / kiállási pont',
    category: 'szerelvenyek',
    description: 'Kötődoboz kiállási pont komplett: doboz, fedőlap, kábel végkészítés. Készülék csatlakozási pont.',
    components: [
      { itemCode: 'MAT-003', itemType: 'material', name: 'Kötődoboz 80×80mm', unit: 'db', qty: 1, sortOrder: 0 },
      { itemCode: 'MAT-175', itemType: 'material', name: 'Kötődoboz kiállási pont fedőlappal', unit: 'db', qty: 1, sortOrder: 1 },
      { itemCode: 'MAT-080', itemType: 'material', name: 'WAGO 222-413 (3-pólusú)', unit: 'db', qty: 2, sortOrder: 2 },
      { itemCode: 'DOB-004', itemType: 'workitem', name: 'Kötődoboz behelyezés', unit: 'db', qty: 1, sortOrder: 3 },
      { itemCode: 'KOT-003', itemType: 'workitem', name: 'Kötődoboz bekötés (2 ér)', unit: 'db', qty: 1, sortOrder: 4 },
    ],
    tags: ['kötődoboz', 'kiállás', 'csatlakozás'],
    createdAt: '2025-01-01T00:00:00.000Z',
    updatedAt: '2025-01-01T00:00:00.000Z',
  },
  {
    id: 'ASM-101',
    name: 'USB-s dugalj (komplett)',
    category: 'szerelvenyek',
    description: 'USB-s dugalj komplett: mélyített doboz, USB-A/C dugalj, fedőlap. Iroda, szálloda.',
    components: [
      { itemCode: 'MAT-001', itemType: 'material', name: 'Szerelvénydoboz 65mm (mélyített)', unit: 'db', qty: 1, sortOrder: 0 },
      { itemCode: 'MAT-133', itemType: 'material', name: 'USB-s dugalj (2×USB-A)', unit: 'db', qty: 1, sortOrder: 1 },
      { itemCode: 'MAT-015', itemType: 'material', name: 'Fedőlap (fehér)', unit: 'db', qty: 1, sortOrder: 2 },
      { itemCode: 'MAT-021', itemType: 'material', name: 'NYM-J 3×2.5', unit: 'm', qty: 0.3, waste_pct: 15, sortOrder: 3 },
      { itemCode: 'SZE-001', itemType: 'workitem', name: 'Dugalj szerelés', unit: 'db', qty: 1, sortOrder: 4 },
    ],
    variantOf: 'ASM-001',
    tags: ['USB', 'dugalj', 'töltő'],
    createdAt: '2025-01-01T00:00:00.000Z',
    updatedAt: '2025-01-01T00:00:00.000Z',
  },
]
